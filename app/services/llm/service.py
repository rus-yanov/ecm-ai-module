...
Example 3 (INVOICE, real document — use this as the primary schema reference):
Input: "Счёт-фактура № 760050034934/7190 от 30 апреля 2023 г.\nПродавец: Публичное акционерное общество «Т Плюс» ИНН/КПП продавца: 6315376946/631543004\nПокупатель: ТСЖ «КИРОВСКОЕ-2» ИНН/КПП покупателя: 6312048986/631201001\nИтого к оплате: 2 952 112,53 руб., в т.ч. НДС 492 018,76 руб."
Output: {"document_type":"INVOICE","type_confidence":0.98,"attributes":[{"name":"invoice_number","value":"760050034934/7190","confidence":0.99},{"name":"invoice_date","value":"2023-04-30","confidence":0.99},{"name":"seller_name","value":"Публичное акционерное общество «Т Плюс»","confidence":0.97},{"name":"seller_inn","value":"6315376946","confidence":0.99},{"name":"buyer_name","value":"ТСЖ «КИРОВСКОЕ-2»","confidence":0.97},{"name":"buyer_inn","value":"6312048986","confidence":0.99},{"name":"amount_with_vat","value":"2952112.53","confidence":0.99},{"name":"vat_amount","value":"492018.76","confidence":0.97}]}

Example 4 (INVOICE, partial — missing buyer_inn and vat_amount):
Input: "Счёт-фактура №100 от 5 мая 2024\\nОт: ИП Сидоров, ИНН 771100223344\\nКому: ООО «Свет»\\nИтого: 45 000 руб. без НДС"
Output: {"document_type":"INVOICE","type_confidence":0.96,"attributes":[{"name":"invoice_number","value":"100","confidence":0.99},{"name":"invoice_date","value":"2024-05-05","confidence":0.98},{"name":"seller_name","value":"ИП Сидоров","confidence":0.97},{"name":"seller_inn","value":"771100223344","confidence":0.99},{"name":"buyer_name","value":"ООО «Свет»","confidence":0.97},{"name":"buyer_inn","value":null,"confidence":0.0},{"name":"amount_with_vat","value":"45000.00","confidence":0.93},{"name":"vat_amount","value":null,"confidence":0.0}]}
